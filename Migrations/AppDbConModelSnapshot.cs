...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMSystem.Model.External_Department", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("side_number");

                    b.ToTable("external_Departments");
                });
            ...
            modelBuilder.Entity("MMSystem.Model.External_Department", b =>
                {
                    b.HasOne("MMSystem.Model.Mail", "Mail_")
                        .WithMany("external_Departments")
                        .HasForeignKey("Mail_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MMSystem.Model.Extrmal_Section", "side_")
                        .WithMany("departments")
                        .HasForeignKey("side_number")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MMSystem.Model.Mail", b =>
                {
                    b.Navigation("external_Departments");
